...
parser.add_argument('--pretrained-ssd', default='models/mobilenet-v1-ssd-mp-0_675.pth', type=str,
...
if __name__ == '__main__':
    ...
    elif args.pretrained_ssd: #We Use This
    ...
    #momentum is slow method
    #optimizer = torch.optim.SGD(params, lr=args.lr, momentum=args.momentum,
    #                            weight_decay=args.weight_decay)
    #optimizer = torch.optim.RMSprop(params, lr=args.lr, momentum=0)
    ...
    # Case 1: milestones=[10, 15, 20], [10, 20, 30]
    if args.scheduler == 'multi-step':
        ...
        scheduler = CosineAnnealingLR(optimizer, args.t_max, last_epoch=last_epoch, eta_min=0.0005)
    elif args.scheduler == 'custom':
        # if you use Custom scheduler, please
        logging.info("Uses Custom scheduler.")
